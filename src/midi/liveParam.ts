 ...
 * to the pedal's live-set wire id (see {@link liveSetId} — deep params set on index+4). Routed
 * through the session's per-param coalescer so a fast drag can't drop its final value on the wire.
 */
